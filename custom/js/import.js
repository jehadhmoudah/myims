$(document).ready(function () {
  ...
  $("#brandfile").fileinput({
    ...
    defaultPreviewContent:
      '<div style="display:flex; flex-direction:row; justify-content:center; align-items:center; padding:16px"><i class="fa-regular fa-file" style="font-size:128px"></i></div>',
    ...
    .bind("submit", function () {
      ...
      if (brandfile == "") {
        $("#brandfile")
          ...
          .after('<p class="text-danger">Brand file field is required</p>');
