	...
	$("#addUserModalBtn").unbind('click').bind('click', function() {
		...
		$("#productImage").fileinput({
	      overwriteInitial: true,
		    ...
		    defaultPreviewContent: '<div style="display:flex; flex-direction:row; justify-content:center; align-items:center; padding:16px"><i class="fa-regular fa-file" style="font-size:128px"></i></div>',
